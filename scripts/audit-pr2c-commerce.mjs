...
const backendFiles = [
    ...
    'app/Http/Middleware/CommerceUtilityHeaders.php',
...
const checks = {
    ...
    SUCCESS_TOKEN_CANONICAL_HITS: count(/canonical[^\n]*(?:\$token|public_token)|(?:\$token|public_token)[^\n]*canonical/gi, source['app/Http/Controllers/Guest/CheckoutController.php']),
    SUCCESS_TOKEN_OG_URL_HITS: count(/og:url[^\n]*(?:\$token|public_token)|(?:\$token|public_token)[^\n]*og:url/gi, source['app/Http/Controllers/Guest/CheckoutController.php']),
    SUCCESS_CANONICAL_OVERRIDE_MISSING: source['app/Http/Controllers/Guest/CheckoutController.php'].includes("'canonical' => null") ? 0 : 1,
    REFERRER_POLICY_MISSING: source['app/Http/Middleware/CommerceUtilityHeaders.php'].includes("'Referrer-Policy' => 'no-referrer'") ? 0 : 1,
