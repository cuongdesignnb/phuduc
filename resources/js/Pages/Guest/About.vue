...
<template>
    ...
    <GuestPageLayout>
        ...
        <section class="relative h-72 md:h-[400px] overflow-hidden flex items-center justify-center">
            ...
            <div class="absolute inset-0 bg-gradient-to-b from-brand-light/70 via-surface-bg/50 to-surface-bg"></div>
            <div class="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[300px] bg-brand-primary/[0.06] rounded-full blur-[120px] pointer-events-none"></div>
            <div class="relative z-10 text-center px-4">
                <p class="section-tag mx-auto">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/></svg>
                    Phú Đức Electric Vehicle
                </p>
                <h1 class="text-4xl md:text-5xl font-display font-bold text-ink-primary mt-4">{{ settings?.['about.title'] || 'Về chúng tôi' }}</h1>
            </div>
        </section>
        ...
        <div class="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 py-16 space-y-16">
            ...
            <section class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div v-if="settings?.['about.vision']" class="glass-card-hover p-8 reveal" style="transition-delay:100ms">
                    ...
                    <h3 class="text-lg font-display font-bold text-ink-primary mb-3">Tầm nhìn</h3>
                    <p class="text-ink-secondary leading-relaxed text-sm">{{ settings['about.vision'] }}</p>
                </div>
            </section>
            ...
            <section class="glass-card p-8 text-center reveal relative overflow-hidden">
                ...
                <div class="relative">
                    <h3 class="text-xl font-display font-bold text-ink-primary mb-6">Liên hệ với chúng tôi</h3>
                    <div class="flex flex-wrap justify-center gap-8 text-sm">
                        <p v-if="settings?.['site.phone']" class="flex items-center gap-2 text-ink-secondary">
                            <svg class="w-4 h-4 text-brand-hover" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/></svg>
                            {{ settings['site.phone'] }}
                        </p>
                        <p v-if="settings?.['site.email']" class="flex items-center gap-2 text-ink-secondary">
                            <svg class="w-4 h-4 text-brand-hover" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
                            {{ settings['site.email'] }}
                        </p>
                        <p v-if="settings?.['site.address']" class="flex items-center gap-2 text-ink-secondary">
