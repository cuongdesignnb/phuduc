...
final class AdminSettingRegistry
{
    ...
    public static function all(): array
    {
        $definitions = [
            ...
            'site.logo' => ['label' => 'Logo', 'description' => 'Logo chính được chọn từ Thư viện Media.', 'group' => 'site', 'type' => 'image', 'default' => null, 'max' => null],
            'site.favicon' => ['label' => 'Favicon', 'description' => 'Biểu tượng trình duyệt được chọn từ Thư viện Media.', 'group' => 'site', 'type' => 'image', 'default' => null, 'max' => null],
            ...
            'about.image' => ['label' => 'Ảnh giới thiệu', 'description' => 'Ảnh trang giới thiệu từ Thư viện Media.', 'group' => 'about', 'type' => 'image', 'default' => null, 'max' => null],
